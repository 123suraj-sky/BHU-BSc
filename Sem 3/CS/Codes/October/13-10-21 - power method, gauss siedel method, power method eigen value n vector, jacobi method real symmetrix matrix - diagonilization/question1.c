/* 
   Write a program to implement Jacobi iteration method for system of Linear equations.
...
int main()
{
   float x0 = 0, y0 = 0, z0 = 0, x1, y1, z1, error_in_x, error_in_y, error_in_z; //notes: 0, 0, 0 is the initial guess
   int iteration = 1;
   do
   {
      x1 = f1(x0, y0, z0);
